            ...
            <div className="relative  w-full justify-center  flex flex-col items-center text-justify">
                ...
                <div className='w-full max-w-3xl -z-0'>
                    <div className="flex flex-row justify-between items-center">  
                        <div className="sm:text-2xl md:text-3xl text-lg mb-1">
                            <FormattedMessage
                            id="travelstay.title"
                ...
                <div className='w-full max-w-3xl mt-10 mb-10 gap-3 flex flex-col '>
                    <div className="sm:text-lg md:text-xl text-sm">
                                <FormattedMessage
                ...
                <div className='w-full max-w-3xl gap-3 flex flex-col '>
