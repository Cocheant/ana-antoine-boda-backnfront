...
const Home = () => {
    ...
    return (
        <section className="relative h-full flex-row pt-20">
            ...
            <div className="bg-no-repeat bg-cover bg-center  h-screen pt-96"
                style={{ backgroundImage: `url(${mainUs})` }}>
                ...
                <div className="sm:text-2xl md:text-5xl text-3xl flex justify-center align-bottom  text-[var(--orange)]   sm:space-x-9 space-x-4 ">
            ...
            <div className="flex justify-center flex-col pb-16  bg-[var(--background)] opacity-60">
                <div className="flex justify-center text-[var(--orange)] md:text-4xl sm:text-4xl text-3xl   pt-20 pb-5">
                    <FormattedMessage
                        id="global.date"
                ...
                <div className="md:text-4xl sm:text-3xl text-2xl flex justify-center text-[var(--orange)] ">
                    <FormattedMessage
                        id="home.secondText"
            ...
            <div className="bg-hero bg-no-repeat  bg-center bg-fixed bg-cover"
                ...
                <div className="md:text-8xl sm:text-7xl text-5xl flex justify-center text-[var(--orange)] pt-44 pb-80">
