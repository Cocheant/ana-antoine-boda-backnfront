...
const Home = () => {
    ...
    return (
        <section className="relative h-full flex-row pt-20">
            ...
            <div className="bg-no-repeat bg-cover bg-center  h-screen pt-96" style={{ backgroundImage: `url(${mainUs})` }}>

                <div className="mt-10 pt-10 pb-10 w-full bg-[var(--background-opaque)] flex flex-col items-center gap-4 select-none">
             
                    <svg id="Capa_1" data-name="Capa 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 924.66 126.66" className='md:w-96 sm:w-64 w-52 text-5xl  flex justify-center'>
            ...
            <div className="flex justify-center items-start flex-row bg-[var(--background)] pt-20 pb-5  md:text-2xl sm:text-xl text-l ">
                <div className="flex justify-center flex-col   bg-[var(--background)] px-8 gap-1">
                    <div className="flex justify-center text-[var(--orange)] border-b-2 border-[var(--orange)] mb-2 pb-2">
                        <FormattedMessage
                            id="global.date"
