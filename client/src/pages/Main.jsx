      ...
      <div className='content '>
        ...
        <section className="relative h-auto flex-row ">
           ...
           <div className={`${isModalOpen
              ...
              <Modal closeCB={()=>{setIsModalOpen(false)} } panelClassName={`${isModalOpen
              ? 'opacity-100 transform duration-700'
              : 'opacity-0 transform'
